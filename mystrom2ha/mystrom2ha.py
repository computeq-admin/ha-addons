...
def write_web_top_page (the_instance, the_url):
    ...
    the_instance.wfile.write(bytes("<link rel=\"stylesheet\" href=\"/resources/mystrom2ha.css\">", "utf-8"))
...
class button_server_handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path.endswith('.css') or self.path.endswith('.htm') or self.path.endswith('.html') :
            ...
            self.wfile.write(bytes("<center><img src=\"/resources/login_icon.jpg\" eight=\"270\" width=\"270\">", "utf-8"))
